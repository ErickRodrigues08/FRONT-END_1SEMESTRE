...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>News Portal | Página da Categoria</title>
...
<h1><?php echo htmlentities($row['category']);?> Notícias</h1>
       ...
       <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
              ...
              <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="btn btn-primary">Ler mais &rarr;</a>
            </div>
...
<?php } ?>
    ...
    <ul class="pagination justify-content-center mb-4">
        ...
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?> " class="page-link">Próximo</a>
        </li>
