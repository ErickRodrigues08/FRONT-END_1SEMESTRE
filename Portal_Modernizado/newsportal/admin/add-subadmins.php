...
<html lang="pt-br">
    <head>
        ...
        <title>Newsportal | Adicionar Sub-admin</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Adicionar Sub-admin</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Adicionar Sub-admin </b></h4>
                                    <hr />
...
<form class="form-horizontal" name="addsuadmin" method="post">
       ...
       <label for="exampleInputusername">Nome de Usuário (used for login)</label>
	         ...
	         <div class="form-group">
	        <label for="emailid">Endereço de Email</label>
