...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Página de Contato</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Página de Contato</h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Atualizar e postar</button>
