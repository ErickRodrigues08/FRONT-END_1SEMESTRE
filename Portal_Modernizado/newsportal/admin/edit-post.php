...
<html lang="pt-br">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Editar Post</title>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Postar detalhes</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Postar imagem</b></h4>
<img src="postimages/<?php echo htmlentities($row['PostImage']);?>" width="300"/>
<br />
<a href="change-image.php?pid=<?php echo htmlentities($row['postid']);?>">Atualizar Imagem</a>
</div>
</div>
</div>
