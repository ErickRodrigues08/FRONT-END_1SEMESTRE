...
if($query)
{
$msg="Imagem do post atualizada com sucesso.";
}
else{
...
<html lang="pt-br">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Adicionar postagem</title>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Imagem Atual do Post</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Nova Imagem da Postagem</b></h4>
