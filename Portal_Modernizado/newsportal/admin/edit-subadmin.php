...
<html lang="en">
    <head>
        ...
        <title>Newsportal |Edit Sub-admin</title>
...
?>
                        		...
                        		<form class="form-horizontal" name="suadmin" method="post">
	                                   ...
	                                   <label class="col-md-2 control-label">Nome de Usuário</label>
	                                   <div class="col-md-10">
            ...
            <div class="form-group">
            <label class="col-md-2 control-label">Endereço de Email</label>
            <div class="col-md-10">
            <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminEmailId']);?>" name="emailid" required>
             ...
             <div class="form-group">
            <label class="col-md-2 control-label">Data de Criação</label>
            <div class="col-md-10">
            <input type="text" class="form-control" value="<?php echo htmlentities($row['CreationDate']);?>" name="cdate" readonly>
             ...
             <div class="form-group">
            <label class="col-md-2 control-label">Data de Atualização</label>
            <div class="col-md-10">
