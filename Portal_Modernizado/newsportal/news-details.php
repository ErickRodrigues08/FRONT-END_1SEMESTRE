...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>News Portal | Página Inicial</title>
...
<p>
          ...
          <b>Última atualização por </b> <?php echo htmlentities($row['lastUpdatedBy']);?> on </b><?php echo htmlentities($row['UpdationDate']);?></p>
        <?php endif;?>
